...
[t1,k1,filters1,normU1,normP1,normUExact1,normPExact1,Uerror1,Perror1] = getData('1e-3second-constant-step.txt')	
...
#plt.show()
plt.plot(t,normU,marker = 'x',label=r'VSVOBE2, $\varepsilon$=1E-3')
...
plt.plot(tFine,exact,':',label=r'Exact $||u||$')
plt.legend()
plt.ylabel(r'$||u||$')
plt.xlabel('t')
plt.xlim([0,45])

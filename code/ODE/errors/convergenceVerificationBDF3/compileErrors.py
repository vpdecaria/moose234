...
[counter,tol,l2L2,l2H1,l2L2Pressure,rejections,dt] = compileErrors('order-1-dt-',dtList)
work = counter + rejections
#order 1 is bdf2
writeErrorsToFile('order-1-dt-',dtList,'order-1.txt')
...
writeErrorsToFile('order-5-dt-',dtList,'order-5.txt')
